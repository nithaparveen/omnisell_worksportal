...
class AttendanceController extends ChangeNotifier {
  ...
  Future<void> fetchAttendance(BuildContext context, String fromDate, String toDate,userId) async {
    isLoading = true;
    notifyListeners();
    final value = await AttendanceService.fetchAttendance(fromDate, toDate,userId);
